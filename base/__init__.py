...
app.config['SECRET_KEY'] = 'habbd6ag63y628##4#t6&&*89*^%$fGbVGFFnN%5$'  # Change this to a secure secret key
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://root:root@localhost:3306/internship?charset=utf8'
# app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql://root:root@localhost/internship?charset=utf8mb4'  # Change charset to utf8mb4
app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False
# Add this line to configure the upload folder
